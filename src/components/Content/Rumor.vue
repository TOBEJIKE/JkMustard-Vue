<!--谣言终结者rumour-->
<!--<template>-->
  <!--<div class="recommend" :style="{'-webkit-overflow-scrolling': scrollMode}">-->
  ...
  <!--export default {-->
    ...
    <!--methods: {-->
      ...
      <!--loadPageList:function () {-->
        <!--this.$http.post('http://m.chinabyte.com/article/jiemo/list.do', {'classify':'rumour', 'pageNo':1, 'pageSize':this.pageSize}).then((response) => {-->
      ...
      <!--},-->
      <!--more:function () {-->
        <!--this.$http.post('http://m.chinabyte.com/article/jiemo/list.do', {'classify':'rumour', 'pageNo':this.pageNo, 'pageSize':this.pageSize}).then((response) => {-->
          <!--if (response.data.code === 200) {-->
            <!--console.log('&#45;&#45;&#45;&#45;&#45;&#45;谣言&#45;&#45;&#45;&#45;&#45;&#45;&#45;&#45;&#45;&#45;')-->
            <!--console.log(response.data.result.articleWapList)-->
